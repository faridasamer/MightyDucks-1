...
function Ticket({ flight, cabinClass, onClick, passengerNo, userID }) {
    ...
    <Grid
      ...
      <Paper
        ...
        <Grid
          ...
          <Link to="booking/214214" replace={true} state={{flight:flight, cabinClass: cabinClass, passengerNo:passengerNo, userID: userID}}>
            <Button
              variant='contained'
              endIcon={<SendIcon />}
